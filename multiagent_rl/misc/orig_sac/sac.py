...
import gym
import time
import multiagent_rl.misc.orig_sac.core as core
from multiagent_rl.utils.logx import EpochLogger


def sac_orig(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
        steps_per_epoch=4000, epochs=100, replay_size=int(1e6), gamma=0.99, 
        polyak=0.995, lr=1e-3, alpha=0.2, a_lr = 1e-3, batch_size=100, start_steps=10000,
    ...
    for t in range(total_steps):
        ...
        # if t >= update_after and t % update_alpha_every == 0:
        #     alpha *= alpha_factor
