...
import warnings
from multiagent_rl.utils.mpi_tools import proc_id, mpi_statistics_scalar
from multiagent_rl.utils.serialization_utils import convert_json
...
class Logger:
    ...
    def flush(self):
        """
        Flush the logger without writing anything, to start logging next epoch
        """
        # if proc_id()==0:
        # vals = []
        # key_lens = [len(key) for key in self.log_headers]
